...
public class SCCGC {
	...
	public static void use7zip(String filename) throws IOException {
		...
		String exec = "./7za a " + zipname + ".7z " + filename + " -m0=PPMD";
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String[] chrs = reference_genome.split("/");
		String final_file = final_folder + "//" + chrs[3].replaceAll(".fa", ".txt");
		...
		System.out.println( "Compressed file is "+final_folder + "/" +chrs[3].replaceAll(".txt", ".7z"));
