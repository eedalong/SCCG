...
public class ORGC {
    ...
    public static void write(String filename, List<Position> list, boolean append, String auxiliary) throws IOException {
    	FileWriter filewriter = new FileWriter(filename, append);
        BufferedWriter output = new BufferedWriter(filewriter);
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String final_folder = args[2]+"//result";// output file folder
		Runtime.getRuntime().exec("mkdir " + final_folder);
		String	final_file;
		int  controuble;
		boolean is_con;
		
		String chrName[] = new String[] { "chr1.fa", "chr2.fa", "chr3.fa", "chr4.fa", "chr5.fa", "chr6.fa", "chr7.fa", "chr8.fa", "chr9.fa",
