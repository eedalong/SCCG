...
public class SCCGD {
	...
	public static void test(String res, String tar) {
		for (int i = 0; i < res.length(); i++) {
			if (res.charAt(i) != tar.charAt(i)) {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] chrs = reference_file.split("/");
		String final_file = args[2] + "//" + chrs[3];
		...
		FileInputStream fileinputstream = new FileInputStream(in_file_name);
		DataInputStream datainputstream = new DataInputStream(fileinputstream);
		BufferedReader bufferedreader = new BufferedReader(new InputStreamReader(datainputstream));
		String line;
		int Pindex = 0;
		...
		StringBuilder target_string = reconstruct(in_file_name, reference);
		...
		System.out.println("Decompressed file is " + args[2] + "/" + chrs[3]);
